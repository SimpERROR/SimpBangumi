...
const { notifications, dismissNotification } = useBroadcastNotify();
</script>
...
<template>
  <TransitionGroup
    ...
    tag="div"
    class="broadcast-notify-container"
    name="broadcast-notify"
  >
    <div
      v-for="notification in notifications"
      :key="notification.id"
      class="broadcast-notify-toast"
    >
      <svg
        class="broadcast-notify-toast__icon"
      ...
      <div class="broadcast-notify-toast__content">
        <p class="broadcast-notify-toast__title">{{ notification.title }}</p>
        <p class="broadcast-notify-toast__message">{{ notification.message }}</p>
      </div>
      <button
        class="broadcast-notify-toast__close"
        type="button"
        aria-label="关闭通知"
